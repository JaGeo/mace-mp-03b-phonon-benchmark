...
for mp_id in os.listdir('/home/jgrandel/mace_phonons/dft_pbe_phonons'):
    try:
        ...
        pass
    print(mp_id)
    phonopy_yaml = f'/home/jgrandel/mace_phonons/mp_0b3_medium_phonons/{mp_id}/phonopy.yaml'
    phonopy_yaml_dft = f'/home/jgrandel/mace_phonons/dft_pbe_phonons/{mp_id}/phonopy.yaml'
    ...
    if os.path.exists(os.path.join('/home/jgrandel/mace_phonons/dft_pbe_phonons', mp_id, 'FORCE_SETS')):
        phonon_prop_dft = Phonon_Properties(phonopy_yaml=phonopy_yaml_dft,
                                            force_sets_filename=os.path.join('/home/jgrandel/mace_phonons/dft_pbe_phonons', mp_id, 'FORCE_SETS'))
    else:
        phonon_prop_dft = Phonon_Properties(phonopy_yaml=phonopy_yaml_dft)
    ...
    try:
        ...
        phonon_frequencies_dft = phonon_prop_dft._run_bands_structure_dict()["frequencies"]
        labels, connections = phonon_prop_dft._get_label_and_connection()
        plot = PhononPlotter(distances_set=([phonon_distance_dft, phonon_distance_dft]),
        ...
        plt.savefig(f'/home/jgrandel/mace_phonons/new_prints/{mp_id}.png', dpi=300, bbox_inches='tight')
    except:
        print(f'PLOT NOT POSSIBLE FOR {mp_id}')

    
    rmse, mae, r2, phon_rmse, phon_mae, phon_scaled_rmse, phon_rrmse = phonon_prop.get_metrics(other=phonon_prop_dft)
